...
& curl.exe -O http://www.7-zip.org/a/7z1801-x64.exe
& curl.exe -O http://www.7-zip.org/a/7z1801-x64.msi
# get from main machine https://www.charlesproxy.com/download/
# get from main machine http://www.7-zip.org/download.html

choco download baretail chocolatey chocolatey-agent chocolatey.extension chocolateygui chocolatey.server   dotnet4.5.2 dotnet4.6.1 git launchy notepadplusplus visualstudiocode virtualbox --internalize  --internalize-all-urls --append-use-original-location --output-directory="'..\demo\packages'"
